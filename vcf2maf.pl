...
my @ann_cols = qw( Allele Gene Feature Feature_type Consequence cDNA_position CDS_position
    ...
    HGVS_OFFSET PHENO MINIMISED GENE_PHENO FILTER flanking_bps vcf_id vcf_qual gnomADg_AF gnomADg_AFR_AF
    gnomADg_AMR_AF gnomADg_ASJ_AF gnomADg_EAS_AF gnomADg_FIN_AF gnomADg_NFE_AF gnomADg_OTH_AF gnomADg_SAS_AF );
